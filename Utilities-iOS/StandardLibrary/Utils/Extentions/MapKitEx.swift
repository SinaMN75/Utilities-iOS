...
extension MKMapView {
     ...
     */
    func addCircleOverlay(coordinate: CLLocationCoordinate2D, radius: Double) { self.addOverlay(MKCircle(center: coordinate, radius: radius)) }
     ...
     */
    func addPolyline(points: [CLLocationCoordinate2D]) { self.addOverlay(MKPolyline(coordinates: points, count: 2)) }
}
