...
extension UIAlertController {
    ...
    func addPhotoLibraryPicker(flow: UICollectionView.ScrollDirection, addButtonTitle: String = "Add",paging: Bool, selection: PhotoLibraryPickerViewController.Selection) {
        let selection: PhotoLibraryPickerViewController.Selection = selection
        var asset: PHAsset?
        var assets: [PHAsset] = []
        
        let buttonAdd = UIAlertAction(title: addButtonTitle, style: .default) { action in
            switch selection {
